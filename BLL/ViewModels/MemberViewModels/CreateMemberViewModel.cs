...
namespace BLL.ViewModels.MemberViewModels
{
    public class CreateMemberViewModel
    {
        ...
        [RegularExpression(@"^[a-zA-Z\s]+$" , ErrorMessage ="Name Contain Only Latters And Spaces")]
        ...
        public DAL.Entities.Enums.Gander Gender { get; set; }
        ...
        public HealthRecordViewModel HealthRecordVM { get; set; } = null!;
