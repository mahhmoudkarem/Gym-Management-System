        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("GymUserValidEmailCheck", "Phone Like '01%' AND Phone Not Like '%[^0-9]%'");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("GymUserValidEmailCheck1", "Phone Like '01%' AND Phone Not Like '%[^0-9]%'");
                });
